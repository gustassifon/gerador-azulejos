# Pedaço de código recuperado de www.github.com/AniAggarwal. Utilizado para testar a efetividade do Tensorflow com
# suporte a GPU. Deixei no projeto para referência. Este "script" deve ser executado de forma autonoma, não faz parte
# da aplicação. Para baixá-lo utilizar o link/comando abaixo:
#
